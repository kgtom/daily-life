...
<p><strong>分析</strong>:一个使用了MQ的项目，我们引入一个技术，要对这个技术的弊端有充分的认识，才能做好预防。<strong>要记住，不要给公司挖坑！</strong><br>
<strong>回答</strong>:回答也很容易，从以下两个个角度来答</p>
<ul>
<li><strong>系统可用性降低</strong>:引入了MQ，一旦消息队列挂了，你的系统不是危险了。因此，系统可用性降低</li>
...
<strong>回答</strong>:</p>
<ol>
<li>查看各种MQ社区活跃度，是否大厂，更新频率</li>
<li>熟悉的开发语言</li>
<li>吞吐量、性能，功能特色</li>
</ol>
<p><strong>如何选择</strong><br>
看使用场景,产品规模，轻量级 vs 重量级</p>
<h3 id="、如何保证消息队列是高可用的？">4、如何保证消息队列是高可用的？</h3>
<p><strong>分析</strong>:在第二点说过了，引入消息队列后，系统的可用性下降。在生产中，没人使用单机模式的消息队列。如果只回答只会订阅和发布消息，大佬就会怀疑你是不是只是自己搭着玩，压根没在生产用过。<strong>请做一个爱思考，会思考，懂思考的程序员。</strong><br>
...
<img src="https://images.cnblogs.com/cnblogs_com/rjzheng/1202350/o_rocketcluster.png" alt="image"><br>
...
<img src="https://images.cnblogs.com/cnblogs_com/rjzheng/1202350/o_kafka.png" alt="image"><br>
...
<strong>要求</strong>，在回答高可用的问题时，应该能逻辑清晰的画出自己的MQ集群架构或清晰的叙述出来。</p>
...
<h2 id="总结">总结</h2>
<p>希望大家打好基本功，<strong>做一个爱思考，懂思考，会思考的程序员</strong>。</p>
<blockquote>
<p>reference:<br>
